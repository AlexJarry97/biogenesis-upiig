      ...
      <section id="info" className="py-20 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {[{icon:"🎤",t:"Conferencias y paneles",d:"Speakers internacionales"},{icon:"☕",t:"Coffee break diario",d:"Networking informal"},{icon:"📜",t:"Constancia UVM",d:"Con aval institucional"},{icon:"🚀",t:"Startup Showcase",d:"Pitch ante inversores"},{icon:"🖼️",t:"Concurso de carteles",d:"Publica en CIBIOS-BUAP"},{icon:"🤝",t:"Networking",d:"+350 asistentes biotech"}].map((x, i) => (
              <div key={i} className="bg-slate-50 hover:bg-amber-50 border border-slate-100 hover:border-amber-200 rounded-3xl p-6 transition-all duration-300 hover:-translate-y-1">
